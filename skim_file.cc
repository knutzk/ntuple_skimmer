...
std::string prompt_cuts{"( selph_index1 >=0 && (ejets_2015 || ejets_2016 || mujets_2015 || mujets_2016) && event_ngoodphotons==1 && ph_drlept[selph_index1] > 1.0 && ph_isoFCT[selph_index1] && (event_mll > 60000 && event_mll < 100000) )"};
